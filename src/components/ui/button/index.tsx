...
function resolvedIconPlacement(
  ...
  const hasBothCustom =
    Boolean(leadingIcon && trailingIcon) && icon === undefined
...
>(function UiButton(props, ref) {
  ...
  const hasDualRow =
    Boolean(leadingIcon && trailingIcon && (icon === undefined || icon === null))
  ...
  const mergedIcon =
    icon ?? leadingIcon ?? trailingIcon ?? undefined
  const mergedPlacement = resolvedIconPlacement(
    leadingIcon,
    trailingIcon,
    icon,
    iconPlacement,
  ...
  return (
    <Button
      ...
      iconPlacement={
        mergedIcon === undefined ? undefined : (mergedPlacement ?? 'start')
      }
    >
      {children}
    </Button>
